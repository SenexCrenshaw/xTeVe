...
settingsCategory.push(new SettingsCategoryItem("{{.settings.category.general}}", "tlsMode,xteveAutoUpdate,hostIP,hostName,tuner,epgSource,enableTapiosinnTVLogos,disallowURLDuplicates,clearXMLTVCache,api"))
