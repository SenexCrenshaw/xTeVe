...
settingsCategory.push(new SettingsCategoryItem("{{.settings.category.general}}", "tlsMode,xteveAutoUpdate,hostIP,tuner,epgSource,enableTapiosinnTVLogos,disallowURLDuplicates,clearXMLTVCache,api"))
